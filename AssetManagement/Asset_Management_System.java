package Practice.AssetManagement;

import java.text.*;
import java.util.*;
public class Asset_Management_System {
    public static void main(String[] args) {
        Asset_Management_System system = new Asset_Management_System();
        system.Run_method();
    }
    ...
    public Asset_Management_System() {
